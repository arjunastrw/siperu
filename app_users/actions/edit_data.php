...
$query = mysqli_prepare($koneksi, "SELECT * FROM tb_peminjaman_users WHERE id=?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($file_tmp, $upload_path)) {
        // UPDATE query
        $query = "UPDATE tb_peminjaman_users SET gedung='$gedung', ruangan='$ruangan', keperluan='$keperluan', 
                  tanggalwaktu_mulai='$tanggalwaktu_mulai', tanggalwaktu_selesai='$tanggalwaktu_selesai', 
                  nama='$nama', details='$details', lampiran='$nama_file' WHERE id='$id'";
        ...
        if ($result) {
            ...
            header('Location: ../index.php?page=data-peminjaman-users&error=' . urlencode($error_message));
            exit();
        }
    } else {
...
<section class="content">
  <div class="container-fluid">
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form method="post" action="actions/update_data.php" enctype="multipart/form-data">
          <!-- Hidden input field for 'id' -->
