          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $no = 0;
                $query = mysqli_query($koneksi, "SELECT * FROM tb_peminjaman_users");
                ...
                ?>
                  <tr>
                    ...
                    <td>
                        <?php
                        $mulaiDateTime = new DateTime($pjm['tanggalwaktu_mulai']);
                        echo $mulaiDateTime->format('d-m-Y H:i');
                        ?>
                    </td>
                    <td>
                        <?php
                        $selesaiDateTime = new DateTime($pjm['tanggalwaktu_selesai']);
                        echo $selesaiDateTime->format('d-m-Y H:i');
                        ?>
                    </td>
