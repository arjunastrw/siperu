<?php
// Pastikan path ke file config.php sudah sesuai
include(__DIR__ . '/../../conf/config.php');

// Check if the form is submitted
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Sanitize dan validate user inputs
    ...
    $tanggalwaktu_mulai_input = $_POST['tanggalwaktu_mulai'];
    $tanggalwaktu_mulai = date('Y-m-d H:i:s', strtotime($tanggalwaktu_mulai_input));
    
    // Convert and validate tanggalwaktu_selesai
    $tanggalwaktu_selesai_input = $_POST['tanggalwaktu_selesai'];
    $tanggalwaktu_selesai = date('Y-m-d H:i:s', strtotime($tanggalwaktu_selesai_input));
    ...
    // Validate if file upload was successful
    if (move_uploaded_file($_FILES['lampiran']['tmp_name'], '../lampiran/' . $nama_file)) {
        // Use prepared statement to prevent SQL injection
        $query = "INSERT INTO tb_peminjaman_admin (gedung, ruangan, keperluan, tanggalwaktu_mulai, tanggalwaktu_selesai, nama, details, lampiran)
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt) {
            mysqli_stmt_bind_param($stmt, "ssssssss", $gedung, $ruangan, $keperluan, $tanggalwaktu_mulai, $tanggalwaktu_selesai, $nama, $details, $nama_file);
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="custom-select" id="gedung" name='gedung' required>
              ...
              <div class="form-group">
                ...
                <select class="custom-select" id="ruangan" name='ruangan' required>
              ...
              <div class="form-group">
                ...
                <select class="custom-select" id="details" name='details' required>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="reservationdatetimeStart">Tanggal & Waktu Mulai</label>
                <div class="input-group date" id="reservationdatetimeStart" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetimeStart" name="tanggalwaktu_mulai" />
            ...
            <div class="form-group">
                <label for="reservationdatetimeEnd">Tanggal & Waktu Selesai</label>
                <div class="input-group date" id="reservationdatetimeEnd" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetimeEnd" name="tanggalwaktu_selesai" />
