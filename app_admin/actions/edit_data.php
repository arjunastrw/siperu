...
$query = mysqli_prepare($koneksi, "SELECT * FROM tb_peminjaman_admin WHERE id=?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($file_tmp, $upload_path)) {
        // UPDATE query
        $query = "UPDATE tb_peminjaman_admin SET gedung='$gedung', ruangan='$ruangan', keperluan='$keperluan', 
